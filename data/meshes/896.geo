...
// Rectangle 1 (top)
Point(1) = {-49.455555555555556, 1.25, 0, 1.0};
Point(2) = {49.455555555555556, 1.25, 0, 1.0};
Point(3) = {49.455555555555556, 4.161111111111111, 0, 1.0};
Point(4) = {-49.455555555555556, 4.161111111111111, 0, 1.0};
...
Rotate { {0, 0, 1}, {0,  1.25,  0}, -0.002 } {
  Surface{1};
}

// Rectangle 2 (bottom)
Point(5) = {-49.455555555555556, -1.25, 0, 1.0};
Point(6) = {49.455555555555556, -1.25, 0, 1.0};
Point(7) = {49.455555555555556, -4.161111111111111, 0, 1.0};
Point(8) = {-49.455555555555556, -4.161111111111111, 0, 1.0};
