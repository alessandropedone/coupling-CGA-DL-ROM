...
// Rectangle 1 (top)
Point(1) = {-49.9, 1.25, 0, 1.0};
Point(2) = {49.9, 1.25, 0, 1.0};
Point(3) = {49.9, 5.05, 0, 1.0};
Point(4) = {-49.9, 5.05, 0, 1.0};
...
// Rectangle 2 (bottom)
Point(5) = {-49.9, -1.25, 0, 1.0};
Point(6) = {49.9, -1.25, 0, 1.0};
Point(7) = {49.9, -5.05, 0, 1.0};
Point(8) = {-49.9, -5.05, 0, 1.0};
