...
// Rectangle 1 (top)
Point(1) = {-49.455555555555556, 1.2944444444444443, 0, 1.0};
Point(2) = {49.455555555555556, 1.2944444444444443, 0, 1.0};
Point(3) = {49.455555555555556, 4.205555555555556, 0, 1.0};
Point(4) = {-49.455555555555556, 4.205555555555556, 0, 1.0};
...
// Rectangle 2 (bottom)
Point(5) = {-50,-0.75, 0, 1.0};
Point(6) = { 50,-0.75, 0, 1.0};
Point(7) = { 50,-4.75, 0, 1.0};
Point(8) = {-50,-4.75, 0, 1.0};
