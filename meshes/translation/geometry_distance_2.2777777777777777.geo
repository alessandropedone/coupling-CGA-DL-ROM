...
// Rectangle 1 (top)
Point(1) = {-50,1.1388888888888888, 0, 1.0};
Point(2) = { 50,1.1388888888888888, 0, 1.0};
Point(3) = { 50,5.138888888888889, 0, 1.0};
Point(4) = {-50,5.138888888888889, 0, 1.0};
...
Rotate { {0, 0, 1}, {-50, 1.1388888888888888, 0}, 0 } {
  Surface{1};
}
