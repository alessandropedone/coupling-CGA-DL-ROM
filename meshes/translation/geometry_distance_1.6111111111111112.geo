...
// Rectangle 1 (top)
Point(1) = {-50,0.8055555555555556, 0, 1.0};
Point(2) = { 50,0.8055555555555556, 0, 1.0};
Point(3) = { 50,4.805555555555555, 0, 1.0};
Point(4) = {-50,4.805555555555555, 0, 1.0};
...
Rotate { {0, 0, 1}, {-50, 0.8055555555555556, 0}, 0 } {
  Surface{1};
}
