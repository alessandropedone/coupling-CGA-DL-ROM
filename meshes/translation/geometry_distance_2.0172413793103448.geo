...
// Rectangle 1 (top)
Point(1) = {-50,1.0086206896551724, 0, 1.0};
Point(2) = { 50,1.0086206896551724, 0, 1.0};
Point(3) = { 50,5.008620689655173, 0, 1.0};
Point(4) = {-50,5.008620689655173, 0, 1.0};
...
Rotate { {0, 0, 1}, {-50, 1.0086206896551724, 0}, 0 } {
  Surface{1};
}

// Rectangle 2 (bottom)
Point(5) = {-50,-1.0086206896551724, 0, 1.0};
Point(6) = { 50,-1.0086206896551724, 0, 1.0};
Point(7) = { 50,-5.008620689655173, 0, 1.0};
Point(8) = {-50,-5.008620689655173, 0, 1.0};
