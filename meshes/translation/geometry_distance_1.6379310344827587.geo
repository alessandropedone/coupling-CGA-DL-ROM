...
// Rectangle 1 (top)
Point(1) = {-50,0.8189655172413793, 0, 1.0};
Point(2) = { 50,0.8189655172413793, 0, 1.0};
Point(3) = { 50,4.818965517241379, 0, 1.0};
Point(4) = {-50,4.818965517241379, 0, 1.0};
...
Rotate { {0, 0, 1}, {-50, 0.8189655172413793, 0}, 0 } {
  Surface{1};
}

// Rectangle 2 (bottom)
Point(5) = {-50,-0.8189655172413793, 0, 1.0};
Point(6) = { 50,-0.8189655172413793, 0, 1.0};
Point(7) = { 50,-4.818965517241379, 0, 1.0};
Point(8) = {-50,-4.818965517241379, 0, 1.0};
