...
// Rectangle 1 (top)
Point(1) = {-50,1.0277777777777777, 0, 1.0};
Point(2) = { 50,1.0277777777777777, 0, 1.0};
Point(3) = { 50,5.027777777777778, 0, 1.0};
Point(4) = {-50,5.027777777777778, 0, 1.0};
...
Rotate { {0, 0, 1}, {-50, 1.0277777777777777, 0}, 0 } {
  Surface{1};
}
