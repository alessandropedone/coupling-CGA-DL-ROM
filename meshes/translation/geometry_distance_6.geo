...
// Rectangle 1 (top)
Point(1) = {-50,3.0, 0, 1.0};
Point(2) = { 50,3.0, 0, 1.0};
Point(3) = { 50,7.0, 0, 1.0};
Point(4) = {-50,7.0, 0, 1.0};
...
// Rectangle 2 (bottom)
Point(5) = {-50,-3.0, 0, 1.0};
Point(6) = { 50,-3.0, 0, 1.0};
Point(7) = { 50,-7.0, 0, 1.0};
Point(8) = {-50,-7.0, 0, 1.0};
