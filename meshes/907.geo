...
// Rectangle 1 (top)
Point(1) = {-49.4, 0.75, 0, 1.0};
Point(2) = {49.4, 0.75, 0, 1.0};
Point(3) = {49.4, 3.55, 0, 1.0};
Point(4) = {-49.4, 3.55, 0, 1.0};
...
// Rectangle 2 (bottom)
Point(5) = {-49.4, -0.75, 0, 1.0};
Point(6) = {49.4, -0.75, 0, 1.0};
Point(7) = {49.4, -3.55, 0, 1.0};
Point(8) = {-49.4, -3.55, 0, 1.0};
