...
// Rectangle 1 (top)
Point(1) = {-49.58965517241379, 1, 0, 1.0};
Point(2) = {49.58965517241379, 1, 0, 1.0};
Point(3) = {49.58965517241379, 4.179310344827586, 0, 1.0};
Point(4) = {-49.58965517241379, 4.179310344827586, 0, 1.0};
...
Rotate { {0, 0, 1}, {-49.58965517241379, 1, 0}, 0 } {
  Surface{1};
}

// Rectangle 2 (bottom)
Point(5) = {-49.58965517241379, -1, 0, 1.0};
Point(6) = {49.58965517241379, -1, 0, 1.0};
Point(7) = {49.58965517241379, -4.179310344827586, 0, 1.0};
Point(8) = {-49.58965517241379, -4.179310344827586, 0, 1.0};
