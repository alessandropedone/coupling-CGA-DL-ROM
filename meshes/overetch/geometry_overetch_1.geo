...
// Rectangle 1 (top)
Point(1) = {-49.0, 1, 0, 1.0};
Point(2) = {49.0, 1, 0, 1.0};
Point(3) = {49.0, 3.0, 0, 1.0};
Point(4) = {-49.0, 3.0, 0, 1.0};
...
// Rectangle 2 (bottom)
Point(5) = {-49.0, -1, 0, 1.0};
Point(6) = {49.0, -1, 0, 1.0};
Point(7) = {49.0, -3.0, 0, 1.0};
Point(8) = {-49.0, -3.0, 0, 1.0};
